...
async function main() {
  ...
  const speakChain = require('../src/voice/speak');
  assert('tts chain', typeof speakChain.speak === 'function');

  const localTts = require('../src/bridge/tts');
  assert('local tts bridge', typeof localTts.speak === 'function');
